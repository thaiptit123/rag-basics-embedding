...
os.system('pandoc bai_2_embedding_tutorial.md -s -o temp_standalone.tex')
...
tex = tex.replace(r'\begin{longtable}[]{@{}ll@{}}', r'\begin{longtable}{|p{0.25\linewidth}|p{0.70\linewidth}|}')
...
tex = tex.replace(r'\begin{longtable}[]{@{}llll@{}}', r'\begin{longtable}{|p{0.1\linewidth}|p{0.15\linewidth}|p{0.2\linewidth}|p{0.45\linewidth}|}') # Cho bảng Top K
...
with open('bai_2_embedding_tutorial.tex', 'w', encoding='utf-8') as f:
    f.write(tex)

print("Generated Final Tex. Now compiling with xelatex...")

os.system('xelatex -interaction=nonstopmode bai_2_embedding_tutorial.tex')
os.system('xelatex -interaction=nonstopmode bai_2_embedding_tutorial.tex') # Run twice for TOC

final_pdf = "12_Embedding và semantic search_Phạm Thành Thái.pdf"
if os.path.exists('bai_2_embedding_tutorial.pdf'):
    shutil.copy('bai_2_embedding_tutorial.pdf', final_pdf)
